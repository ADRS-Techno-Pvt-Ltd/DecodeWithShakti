...
function couponStatus(coupon: Coupon) {
  if (!coupon.isActive) return <StatusBadge tone="muted">Inactive</StatusBadge>;
  if (new Date(coupon.expiresAt) < new Date())
    return <StatusBadge tone="destructive">Expired</StatusBadge>;
  if (coupon.usedCount >= coupon.usageLimit)
    return <StatusBadge tone="destructive">Exhausted</StatusBadge>;
